...
import 'package:shrubs/routes/favorites/widgets/favorite_products_helper.dart';
import 'package:shrubs/routes/favorites/widgets/favorite_products_tiles.dart';
...
class _FavoriteProductsState extends State<FavoriteProducts> {
  ...
  List<Widget> getFavoriteProductsTiles(BuildContext context) {
    List<int> favoriteProductsIdList = ShrubsAppSession.of(context).user.favorites.map((product) {return product.id;}).toList();
