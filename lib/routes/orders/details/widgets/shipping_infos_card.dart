              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(height: 4),
                    Text('${ShrubsAppSession.of(context).user.name}', style: TextStyle(color: Color(0xFF757575))),
                    SizedBox(height: 4),
                    Text('${order.info.address}', style: TextStyle(color: Color(0xFF757575))),
                    SizedBox(height: 4),
                    Text('${ShrubsAppSession.of(context).user.phone}', style: TextStyle(color: Color(0xFF757575))),
                  ],
                ),
                Spacer(),
